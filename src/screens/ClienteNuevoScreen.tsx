...
type ClienteNuevoScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'ClienteNuevoScreen'
>;

function ClienteNuevoScreen() {
  const navigation = useNavigation<ClienteNuevoScreenNavigationProp>();
...
export default ClienteNuevoScreen;
