...
import { PROVEEDORES_URL } from '../utils/proveedores';
import {
  PRODUCTOS_URL,
...
type ProveedorNuevoScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'ProveedorNuevoScreen'
>;

function ProveedorNuevoScreen() {
  const navigation = useNavigation<ProveedorNuevoScreenNavigationProp>();
  ...
  const handleGuardar = async () => {
    ...
    if (!nit.trim()) {
      setError('Ingresa el NIT del proveedor.');
      return;
    }
